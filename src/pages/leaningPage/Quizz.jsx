...
import { Card, Radio, Alert, Row, Col, Form, Button, Skeleton, message, Modal, Tag, ConfigProvider, Image } from 'antd';
import { DeleteFilled, FlagFilled, FlagOutlined, SnippetsOutlined } from '@ant-design/icons';
import { useSelector } from 'react-redux';
import { selectCurrentUser } from '../../slices/auth.slice';
import ChucMung from './../../assets/image/chucmung.gif'
import Buon from './../../assets/image/buon.webp'
    ...
    return (
        <>
            ...
            >
                <Row>
                    <Col>
                        <Image preview={false} src={score >= 80 ? ChucMung : Buon} />
                    </Col>
                    <Col>
                        <h2 className={`${score >= 80 ? 'text-green-600' : 'text-red-600'} font-bold`}>{score >= 80 ? "Hoàn thành bài kiểm tra!" : "Bạn không vượt qua hãy thử lại !"}</h2>
                        <p >Điểm của bạn: <span className={`${score >= 80 ? 'text-green-600' : 'text-red-600'} font-bold`}>{score}</span></p>
